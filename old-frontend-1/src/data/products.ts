...
export const products: Product[] = [
  ...
  },
  {
    ...
    description:
      'Authentic Ceylon cinnamon sticks with sweet, delicate flavor. Perfect for baking, tea, and desserts.',
    price: 18.99,
  ...
  },
  {
    ...
    description:
      'Traditional Indian spice blend with cardamom, cinnamon, cloves, and more. Essential for authentic Indian cuisine.',
    price: 14.99,
  ...
  },
  {
    ...
    description:
      'Premium whole black peppercorns with intense flavor and aroma. Freshly sourced from Malabar coast.',
    price: 16.99,
    category: categories[0], // Whole Spices
  ...
  },
  {
    ...
    name: 'Smoked Paprika',
    description:
      'Spanish smoked paprika with rich, smoky flavor. Perfect for paella, grilled meats, and vegetables.',
    price: 13.99,
    category: categories[1], // Ground Spices
  ...
  },
  {
    ...
    name: 'Cardamom Pods',
    description:
      'Green cardamom pods with intense aroma and flavor. Essential for Indian sweets, tea, and rice dishes.',
    price: 24.99,
    originalPrice: 29.99,
    category: categories[0], // Whole Spices
  ...
  },
  {
    ...
    name: 'Cumin Seeds',
    description:
      'Whole cumin seeds with earthy, warm flavor. Perfect for tempering, grinding, and Middle Eastern cuisine.',
    price: 9.99,
  ...
  },
  {
    ...
    name: 'Dried Oregano',
    description:
      'Mediterranean dried oregano with robust flavor. Perfect for pizza, pasta, and Mediterranean dishes.',
    price: 8.99,
  ...
  },
  {
    ...
    name: 'Star Anise',
    description:
      'Whole star anise with sweet licorice flavor. Essential for Asian cuisine, mulled wine, and baking.',
    price: 19.99,
    category: categories[0], // Whole Spices
  ...
  },
  {
    ...
    name: 'Curry Powder',
    description:
      'Mild curry powder blend with turmeric, coriander, and cumin. Perfect for beginners to Indian cooking.',
    price: 11.99,
    category: categories[2], // Spice Blends
