...
export const Input = forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const variantClasses = {
      default:
        'border-0 border-b-2 border-gray-300 focus:border-orange-500 bg-transparent rounded-none',
      filled:
        'border border-gray-300 focus:border-orange-500 bg-gray-50 focus:bg-white rounded-lg hover:border-gray-400',
      outlined:
        'border-2 border-gray-300 focus:border-orange-500 bg-white rounded-lg shadow-sm hover:shadow-md hover:border-gray-400',
    };
