...
export const ImageUpload: React.FC<ImageUploadProps> = ({
  ...
  const processFiles = useCallback((files: FileList | File[]) => {
    ...
    const totalFiles = imageFiles.length + existingImages.length + fileArray.length;
  ...
  }, [imageFiles, existingImages.length, maxFiles, maxSizeInMB, acceptedTypes, addToast, onImagesChange]);
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <div className="text-lg font-medium text-gray-700">
            {canAddMore ? 'Upload Images' : `Maximum ${maxFiles} images reached`}
          </div>
