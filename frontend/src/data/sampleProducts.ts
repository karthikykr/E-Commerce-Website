...
export const sampleProducts = [
  {
    ...
    description:
      'High-quality turmeric powder with rich color and aroma. Perfect for cooking and health benefits. Our turmeric is sourced from the finest farms and processed with care to retain maximum nutritional value.',
  ...
  },
  {
    ...
    description:
      'Traditional Indian spice blend with perfect balance of warmth and flavor. Made from carefully selected whole spices that are roasted and ground to perfection.',
  ...
  },
  {
    ...
    description:
      'Premium organic green cardamom pods with intense aroma and flavor. These cardamom pods are hand-picked and carefully dried to preserve their natural oils and fragrance.',
  ...
  },
  {
    ...
    description:
      'Fresh organic basil leaves perfect for cooking and garnishing. These aromatic leaves are carefully harvested and packed to maintain freshness and flavor.',
  ...
  },
  {
    ...
    description:
      'Spicy red chili powder made from premium quality chilies. This vibrant red powder adds heat and color to your dishes while maintaining authentic flavor.',
  ...
  },
  {
    ...
    description:
      'Premium Ceylon cinnamon sticks with sweet and warm flavor. These authentic cinnamon sticks are perfect for both sweet and savory dishes.',
  ...
  },
  {
    ...
    slug: 'cumin-seeds',
    description:
      'Whole cumin seeds with earthy and warm flavor. These premium quality cumin seeds are essential for Indian cooking and add depth to any dish.',
  ...
  },
  {
    ...
    description:
      'Organic whole black peppercorns with intense flavor and aroma. These premium peppercorns are perfect for grinding fresh or using whole in cooking.',
