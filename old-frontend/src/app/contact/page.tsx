      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            questions about our homemade food products and services.
          </p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                "At Gruhapaaka, we're passionate about bringing you the finest
                homemade food products made with traditional recipes. Our
                commitment to quality and authenticity drives everything we do.
                I personally oversee our sourcing process to ensure every
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <svg
                    className="h-6 w-6 text-orange-600 mr-3 mt-1"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Authentic Homemade Food Products
                    </p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Customer Service: +91 98765 43211
                    </p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      General: info@gruhapaaka.com
                    </p>
                    <p className="text-gray-600">CEO: karthik@gruhapaaka.com</p>
                    <p className="text-gray-600">
                      Support: support@gruhapaaka.com
                    </p>
          ...
          <div className="bg-gray-100 rounded-lg h-64 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500 mt-2">
                123 Home Kitchen Street, Flavor District, Mumbai 400001
              </p>
            </div>
          </div>
        </div>
