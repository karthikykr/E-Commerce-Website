...
export const DynamicSection: React.FC<DynamicSectionProps> = ({
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-center justify-center lg:justify-start space-x-2 sm:space-x-3 mb-4 sm:mb-6">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs sm:text-sm text-orange-600 font-medium -mt-1">
                ...
                <p className="text-lg sm:text-xl lg:text-2xl text-gray-600 max-w-2xl mx-auto lg:mx-0 leading-relaxed px-4 lg:px-0 font-medium">
                  Indulge in elegant homemade food products, crafted with the
                  finest ingredients and traditional recipes passed down through
                  generations.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 pt-6 sm:pt-8 px-4 lg:px-0">
                  ...
                  <Link href="/about" className="w-full sm:w-auto">
                    <Button
                      variant="outline"
                      className="border-3 border-orange-400 text-orange-700 hover:bg-orange-50 hover:border-orange-500 px-10 sm:px-12 py-4 sm:py-5 text-lg sm:text-xl font-bold rounded-2xl transition-all duration-300 transform hover:scale-105 w-full sm:w-auto"
                    >
                      Learn More
                      <svg
                        className="w-6 h-6 ml-2 inline"
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-10">
                  <div className="space-y-4 sm:space-y-6">
                    <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6 transform rotate-1 sm:rotate-3 hover:rotate-0 transition-all duration-500 hover:shadow-2xl border border-orange-100">
                      ...
                      <h3 className="font-bold text-xs sm:text-sm text-gray-800 mb-2">
                        FLAX SEEDS CHUTNEY POWDER
                      </h3>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          <span className="bg-orange-600 text-white text-xs px-2 sm:px-3 py-1 rounded-full font-bold">
                            JUST
                          </span>
                          <span className="ml-1 sm:ml-2 text-xs text-orange-600 font-semibold">
                            Gruhapaaka
                          </span>
                        </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
                  <div className="bg-white rounded-lg sm:rounded-xl shadow-lg p-3 sm:p-4 transform rotate-1 hover:rotate-0 transition-all duration-300 hover:shadow-xl border border-orange-100">
                    ...
                    <h4 className="font-bold text-xs text-gray-800 text-center">
                      PURE HONEY
                    </h4>
                    <p className="text-orange-600 font-bold text-xs text-center mt-1">
                      ₹399
                    </p>
                  </div>
                  <div className="bg-white rounded-lg sm:rounded-xl shadow-lg p-3 sm:p-4 transform -rotate-1 hover:rotate-0 transition-all duration-300 hover:shadow-xl border border-orange-100">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mt-8 sm:mt-10">
          <Link href="/products?discount=true">
            <Button
              variant="outline"
              className="bg-white border-2 border-orange-400 text-orange-700 hover:bg-orange-50 hover:border-orange-500 px-8 py-3 text-lg font-semibold rounded-xl transition-all duration-300 transform hover:scale-105"
            >
              View All Deals
              <svg
              ...
              [
                {
                  name: 'Whole Spices',
                  description:
                    'Fresh whole spices for maximum flavor and aroma',
                  icon: '🌶️',
                },
                {
                  name: 'Ground Spices',
              ...
              {section.content.stats && (
                <div className="grid grid-cols-2 gap-6 pt-4">
                  {section.content.stats.map((stat: any, index: number) => (
                    <div
                      key={index}
                      className="text-center p-4 bg-white rounded-xl shadow-lg border border-orange-100"
                    >
              ...
              <div className="w-96 h-96 mx-auto">
                <div className="w-full h-full bg-gradient-to-br from-orange-200 via-amber-200 to-red-200 rounded-full flex items-center justify-center shadow-2xl relative overflow-hidden">
                  <div className="w-80 h-80 bg-gradient-to-br from-orange-600 via-amber-600 to-red-600 rounded-full flex items-center justify-center shadow-inner relative">
                    ...
                    <div className="absolute top-8 right-8 text-2xl animate-pulse">
                      🌿
                    </div>
                    <div className="absolute bottom-8 left-8 text-2xl animate-bounce delay-300">
                      🥄
                    </div>
                    <div className="absolute bottom-8 right-8 text-2xl animate-pulse delay-500">
                      🍯
                    </div>
  ...
  return (
    <section className={className} style={getSectionStyle()}>
      {section.settings.customCSS && (
        <style
          dangerouslySetInnerHTML={{ __html: section.settings.customCSS }}
        />
      )}
      {renderSection()}
    </section>
