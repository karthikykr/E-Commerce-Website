  ...
  const defaultSections = [
    {
      ...
      subtitle: 'Indulge in elegant homemade food products, made with the finest ingredients and traditional recipes.',
      displayOrder: 0,
      isActive: true,
      content: {
        buttonText: 'Shop Now',
    ...
    },
    {
      ...
      subtitle: 'We dedicate ourselves to purity, authenticity, and traditional methods.',
      displayOrder: 1,
      isActive: true,
      content: {
        description: 'We dedicate ourselves to purity, authenticity, and traditional methods in creating homemade food products. Our commitment to traditional recipes and homemade goodness ensures every product carries the essence of home-cooked meals.',
        stats: [
    ...
    },
    {
      ...
      subtitle: 'Handpicked favorites that our customers love most - premium quality spices and seasonings',
      displayOrder: 3,
      isActive: true,
      content: {
        maxProducts: 8,
    ...
    },
    {
      ...
      subtitle: 'Explore our carefully curated categories of premium spices and seasonings',
      displayOrder: 4,
      isActive: true,
      content: {
        maxCategories: 4,
    ...
    },
    {
      ...
      subtitle: 'We\'re committed to bringing you the finest homemade food products with unmatched quality and traditional taste',
      displayOrder: 5,
      isActive: true,
      content: {
        features: [
          {
            ...
            description: 'Made with love in home kitchens using traditional recipes and the finest ingredients.'
          },
          {
            icon: '🚚',
            title: 'Fast Delivery',
            description: 'Free shipping on orders over $50. Get your homemade delicacies delivered fresh to your doorstep.'
          },
          {
            icon: '🔒',
    ...
    },
    {
      ...
      subtitle: 'Get the latest updates on new homemade products, special offers, and traditional recipes delivered to your inbox.',
      displayOrder: 6,
      isActive: true,
      content: {
