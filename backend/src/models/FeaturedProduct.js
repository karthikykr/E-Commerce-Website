...
const featuredProductSchema = new mongoose.Schema({
  ...
  position: {
    type: String,
    enum: ['hero-main-1', 'hero-main-2', 'hero-bottom-1', 'hero-bottom-2', 'hero-bottom-3'],
  ...
  rotation: {
    type: String,
    enum: ['rotate-1', 'rotate-2', 'rotate-3', '-rotate-1', '-rotate-2', '-rotate-3', 'rotate-0'],
    default: 'rotate-1'
  },
  hoverRotation: {
    type: String,
    enum: ['rotate-0', 'rotate-1', 'rotate-2', 'rotate-3', '-rotate-1', '-rotate-2', '-rotate-3'],
    default: 'rotate-0'
  },
  createdBy: {
...
featuredProductSchema.statics.getHomepageProducts = function() {
  return this.find({ isActive: true })
    .sort({ displayOrder: 1 })
    .select('name price originalPrice image emoji backgroundColor position animation rotation hoverRotation');
};
