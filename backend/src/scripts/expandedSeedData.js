...
const connectDB = async () => {
  try {
    await mongoose.connect(
      process.env.MONGODB_URI || "mongodb://localhost:27017/spice-store",
    );
...
const categories = [
  {
    name: "Whole Spices",
    slug: "whole-spices",
    description: "Fresh whole spices for authentic flavors",
  ...
  },
  {
    name: "Ground Spices",
    slug: "ground-spices",
    description: "Finely ground spices ready to use",
  ...
  },
  {
    name: "Spice Blends",
    slug: "spice-blends",
    description: "Traditional and exotic spice blends",
...
const createProducts = (categories) => [
  ...
  // Indian Masalas
  {
    ...
    weight: { value: 100, unit: "g" },
    origin: "India",
    tags: ["kidney beans", "north indian"],
  },
  {
    name: "Chole Masala",
    slug: "chole-masala",
  ...
  },
  {
    ...
    weight: { value: 100, unit: "g" },
    origin: "India",
    tags: ["organic", "warming"],
  },
  {
    name: "Organic Cardamom Powder",
    slug: "organic-cardamom-powder",
    price: 2999,
    category: categories[7]._id,
    stockQuantity: 15,
    weight: { value: 50, unit: "g" },
...
const seedExpandedData = async () => {
  try {
    ...
    const productsWithDetails = productData.map((product) => ({
      ...
      description:
        product.description ||
        `High-quality ${product.name.toLowerCase()} sourced from ${product.origin}. Perfect for authentic cooking and exceptional flavor.`,
      shortDescription:
        product.shortDescription ||
        `Premium ${product.name.toLowerCase()} from ${product.origin}`,
