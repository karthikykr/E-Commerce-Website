...
const sampleProducts = [
  {
    ...
    description: "Premium quality organic turmeric powder, perfect for cooking and health benefits. Rich in curcumin and antioxidants.",
    price: 12.99,
    stockQuantity: 50,
    weight: {
      value: 100,
  ...
  },
  {
    ...
    description: "Authentic Ceylon cinnamon sticks with sweet and delicate flavor. Perfect for baking and beverages.",
    price: 18.50,
    stockQuantity: 30,
    weight: {
      value: 50,
  ...
  },
  {
    ...
    description: "Premium whole black peppercorns with intense flavor and aroma. Essential for any kitchen.",
    price: 15.75,
    stockQuantity: 40,
    weight: {
      value: 100,
  ...
  },
  {
    ...
    description: "Pure Himalayan pink salt crystals, rich in minerals and perfect for cooking and seasoning.",
    price: 9.99,
    stockQuantity: 60,
    weight: {
      value: 500,
  ...
  },
  {
    name: "Cardamom Pods",
    slug: "cardamom-pods",
    description: "Aromatic green cardamom pods, the queen of spices. Perfect for desserts and chai.",
    price: 24.99,
    stockQuantity: 25,
    weight: {
      value: 50,
